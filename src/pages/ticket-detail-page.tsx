...
const TicketDetailPage: React.FC<TicketDetailPageProps> = (
  ...
  const handleUpdateTicket = (key: keyof Ticket, value: Ticket[typeof key]) => {
  ...
  const handleSave = async (
    ...
    if (
      ...
      try {
        ...
        setError("There was an issue updating the Assignee on this ticket");
        console.error(error);
      }
    }
      ...
      <form>
        <div>
          ...
          <input
            ...
            onChange={(e) => handleUpdateTicket("description", e.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => handleUpdateTicket("completed", e.target.checked)}
          />
        </div>
